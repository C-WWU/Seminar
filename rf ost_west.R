...
predictions1 <- predict(model1, newdata=test_dfOst_West)


# Create confusion matrix

confusionMatrix(data=predictions1, test_dfOst_West$Ost_West)
...
predictions2 <- predict(model2, newdata=test_dfOst_West)


# Create confusion matrix

confusionMatrix(data=predictions2, test_dfOst_West$Ost_West)
...
bestmtry <- modelOst_West$bestTune$mtry
